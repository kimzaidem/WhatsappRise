...
class Envapi
{
    ...
    public function validatePurchase($module_name)
    {
        ...
        if (!$verified) {
            ...
            $sql_query = "DELETE FROM `" . $dbprefix . "settings` WHERE `" . $dbprefix . "settings`.`setting_name` IN ('".$module_name."_verification_id', '".$module_name."_last_verification', '".$module_name."_product_token', '".$module_name."_heartbeat');";
            $db->query($sql_query);
